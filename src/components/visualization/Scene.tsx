...
const Scene: React.FC = () => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 5; i++) {
      const satelliteGeometry = new THREE.SphereGeometry(0.04 * EARTH_RADIUS, 10, 10); // Slightly smaller, simpler
  ...
  useEffect(() => { /* ... (marker color logic, no change needed here for this pass) ... */
